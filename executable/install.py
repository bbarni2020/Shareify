...
def initialize_users_db():
    ...
    default_user = {'username': 'admin', 'password': password, 'name': 'Administrator', 'ip': '', 'role': 'admin', 'ftp_users': '', 'paths': '[""]', 'settings': '', 'API_KEY': api_key, 'paths_write': '[""]'}
    try:
        cursor.execute('\n            INSERT INTO users (username, password, name, ip, role, ftp_users, paths, settings, API_KEY, paths_write)\n            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)\n        ', (default_user['username'], default_user['password'], default_user['name'], default_user['ip'], default_user['role'], default_user['ftp_users'], default_user['paths'], default_user['settings'], default_user['API_KEY'], default_user['paths_write']))
