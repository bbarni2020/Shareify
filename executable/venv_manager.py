...
def main():
    ...
    parser.add_argument('action', choices=['create', 'remove', 'install', 'info', 'run'], help='Action to perform')
    parser.add_argument('command', nargs='*', help="Command to run (for 'run' action)")
